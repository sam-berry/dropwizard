...
/**
 * Created by artem on 26.10.17.
 */
public class ClassicJsonFileAppenderFactoryTest {
    ...
    public void isDiscoverable() throws Exception {
        assertThat(new DiscoverableSubtypeResolver().getDiscoveredSubtypes())
            .contains(ClassicJsonFileAppenderFactory.class);
    }

    @Test
    public void appenderContextIsSet() throws Exception {
        final Logger root = (Logger) LoggerFactory.getLogger(org.slf4j.Logger.ROOT_LOGGER_NAME);
        final ClassicJsonFileAppenderFactory appenderFactory = new ClassicJsonFileAppenderFactory();
